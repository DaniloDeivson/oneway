...
BEGIN
  ...
  CASE NEW.severity
    WHEN 'Baixa' THEN v_cost_amount := 50;
    WHEN 'Média' THEN v_cost_amount := 150;
    WHEN 'Alta' THEN v_cost_amount := 500;
    ELSE v_cost_amount := 100;
  END CASE;
  ...
  INSERT INTO costs (
    ...
    'Funilaria',
    v_vehicle_id,
    'Danos identificados em inspeção: ' || NEW.description,
    v_cost_amount,
    NOW()::date,
    'Pendente',
    'Patio',
